...
class BuildAPersonalView extends StatefulWidget {

  @override
  _BuildAPersonalViewState createState() => _BuildAPersonalViewState();
}

class _BuildAPersonalViewState extends State<BuildAPersonalView> {
